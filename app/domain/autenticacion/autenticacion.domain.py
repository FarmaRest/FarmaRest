...
# Evitar registro doble del modelo
if 'autenticacion_domain_loaded' not in sys.modules:
    sys.modules['autenticacion_domain_loaded'] = True
    ...
    from app.core.base import Base
    Sesion = Base.registry._class_registry.get('Sesion')