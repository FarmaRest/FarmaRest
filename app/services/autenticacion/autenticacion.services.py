...
class AutenticacionService:
    ...
    def login(self, correo: str, contrasena: str) -> dict:
        ...
        if usuario.estado == "inactivo":
            raise HTTPException(status_code=403, detail={
                ...
                "error": {"error_code": "ACCOUNT_INACTIVE",
        ...
        if usuario.rol == "administrador" and usuario.fecha_cambio_contrasena:
            ...
            if dias_desde_cambio > PASSWORD_EXPIRE_DAYS:
                raise HTTPException(status_code=403, detail={
                    ...
                    "error": {"error_code": "PASSWORD_EXPIRED",
    ...
    def refresh_token(self, refresh_token: str) -> dict:
        ...
        return {"success": True, "statusCode": 200, "message": "Token renovado correctamente",
                "data": {"accessToken": nuevo_access_token, "expiresIn": 3600}}
    ...
    def cambiar_contrasena(self, correo: str, contrasena_actual: str, contrasena_nueva: str) -> dict:
        ...
        return {"success": True, "statusCode": 200, "message": "Contraseña actualizada correctamente.",
                "data": {"usuarioId": str(usuario.id), "correo": usuario.correo, "fechaCambioContrasena": ahora.isoformat()}}