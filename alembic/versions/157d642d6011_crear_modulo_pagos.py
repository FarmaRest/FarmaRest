...
Revision ID: 157d642d6011
Revises: d4e5f6a7b8c9
Create Date: 2026-06-11 00:08:31.753466
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('subtotal_base',  sa.Numeric(10, 2),          nullable=False),
        sa.Column('total_iva',      sa.Numeric(10, 2),          nullable=False),
    ...
    op.create_index('idx_pagos_usuario',  'pagos', ['usuario_id'])
